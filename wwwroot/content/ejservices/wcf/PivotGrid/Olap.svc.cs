    ...
    public class Olap : IOlap
    {
        ...
        private OlapReport CreateOlapReport(bool isPaging)
        {
            ...
            if (isPaging)
            {
                ...
                DimensionElement dimensionElement = new DimensionElement() { Name = "Admin" };
                dimensionElement.AddLevel("Admin", "Admin");
                olapReport.CategoricalElements.Add(dimensionElement);

                DimensionElement dimensionElementRow = new DimensionElement() { Name = "Admin", HierarchyName = "Admin" };
